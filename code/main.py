...
def run_best_scenario(output_dir=None):
    ...
    # Use the working gains from milestone 3 tests that successfully complete
    # the pick-and-place trajectory with large initial pose error.
    # These gains match the "large_error" test case that works correctly.
